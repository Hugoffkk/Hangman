...
class RuleFourScreen(QWidget):
    ...
    def __init__(self):
        ...
        # [Title]
        self.title = QLabel(self.language["rule4"])
        self.title.setObjectName("defeatTitle")
        self.title.setWordWrap(True)

        # [Images]
        self.image = QLabel()
        self.pixmap = QPixmap(str(get_assets_route("assets/images_tutorial/rule_4.png"))).scaled(450, 450, Qt.KeepAspectRatio, Qt.SmoothTransformation)
