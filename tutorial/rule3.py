...
class RuleThreeScreen(QWidget):
    ...
    def __init__(self):
        ...
        # [Images]
        self.image = QLabel()
        self.pixmap = QPixmap(str(get_assets_route("assets/images_tutorial/rule_3.png"))).scaled(450, 450, Qt.KeepAspectRatio, Qt.SmoothTransformation)
