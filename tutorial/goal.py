...
class GoalScreen(QWidget):
    ...
    def __init__(self):
        ...
        # [Title]
        self.title = QLabel(self.language["goal"])
        self.title.setObjectName("defeatTitle")
        self.title.setWordWrap(True)

        # [Images]
        self.image = QLabel()
        self.pixmap = QPixmap(str(get_assets_route("assets/images_tutorial/won_game.png"))).scaled(450, 450, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        ...
        self.next_arrow.setFixedWidth(40)
        self.next_arrow.setCursor(Qt.PointingHandCursor)
